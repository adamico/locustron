...
function create_test_objects(count)
   local objects = {}
   for i = 1, count do
      objects[i] = {
         x = rnd(500),
...
function benchmark_add_operations(object_count)
...
function benchmark_query_operations(object_count)
   local loc = locustron(GRID_SIZE)
   local objects = create_test_objects(object_count)
...
function benchmark_filtered_query_operations(object_count)
   local loc = locustron(GRID_SIZE)
   local objects = create_test_objects(object_count)
...
function benchmark_delete_operations(object_count)
   local loc = locustron(GRID_SIZE)
   local objects = create_test_objects(object_count)
