  ...
  for scenario_name, scenario_results in pairs(results) do
    for count, count_results in pairs(scenario_results) do
      for strategy_name, strategy_results in pairs(count_results) do
        ...
        strategy_totals[strategy_name].add_time = strategy_totals[strategy_name].add_time + strategy_results.add_time
        strategy_totals[strategy_name].query_time = strategy_totals[strategy_name].query_time + strategy_results.query_time
        strategy_totals[strategy_name].memory_usage = strategy_totals[strategy_name].memory_usage + strategy_results.memory_usage
        strategy_totals[strategy_name].accuracy = strategy_totals[strategy_name].accuracy + strategy_results.accuracy
...
function BenchmarkCLI.output_csv(results)
  -- CSV header
  print("scenario,object_count,strategy,add_time_ms,query_time_ms,update_time_ms,remove_time_ms,memory_kb,accuracy_percent")
