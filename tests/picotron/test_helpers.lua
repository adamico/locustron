...
function assert_obj_count(loc, expected_count, message)
   ...
   elseif actual_count ~= expected_count then
      local error_msg = message
         or ("Expected " .. tostring(expected_count) .. " objects, got " .. tostring(actual_count))
      test_fail(error_msg)
   end
end
...
function assert_bbox(loc, obj, expected_x, expected_y, expected_w, expected_h, message)
   ...
   elseif x ~= expected_x or y ~= expected_y or w ~= expected_w or h ~= expected_h then
      local expected_str = tostring(expected_x)
         .. ","
         .. tostring(expected_y)
         .. ","
         .. tostring(expected_w)
...
function assert_query_count(results, expected_count, message)
   ...
   if actual_count ~= expected_count then
      local error_msg = message
         or ("Expected " .. tostring(expected_count) .. " objects in query results, got " .. tostring(actual_count))
      test_fail(error_msg)
   end
end
